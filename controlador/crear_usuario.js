    ...
    Usuario.find({}, (err, usuarios) => {
      if (err) {
        ...
        if (usuarios.length <= 0) {
			...
			nuevoUsuario1.nombre = 'Dennys Huaman Chaparro'
			nuevoUsuario1.email = 'dennysalvaro01@gmail.com'
			...
			nuevoUsuario2.nombre = 'Gabriel Huaman Pazo'
			nuevoUsuario2.email = 'gabrielfranco01@gmail.com'
			nuevoUsuario2.clave = '12345'
